...
fs_mm_xgb3 = {'y_train_36': ['stock_price_Lag_12', 'Fossil_Ita_Lag_12', 'GER Production Index_Lag_12', '#12_Lag_3', 'Fossil_Chi_Lag_12_RollingMean3', '#6_Lag_1_RollingMean12', '#9_Lag_12', 'CC_UK_Lag_12_RollingMean3', 'Clean_Chi_Lag_12_RollingMean3', '#13_Lag_1_RollingMean3', '#8_Lag_3', '#16_Lag_1_RollingMean3', '#3_Lag_1_RollingMean12', 'FRA Production Index_Lag_12', '#1_Lag_1_RollingMean3', 'BC_CHI_Lag_12', '#14_Lag_1', '#5_Lag_1_RollingMean3', '#36_Lag_12', 'GER EE Production Index_Lag_12_RollingMean3', '#4_Lag_1_RollingMean3', '#16_Lag_3_RollingMean6', 'Clean_Fra_Lag_12'], 'y_train_8': ['#13_Lag_3_RollingMean6', 'CHI Production Index_Lag_12', '#6_Lag_1_RollingMean3', '#36_Lag_12', '#16_Lag_1_RollingMean3', 'Clean_Ita_Lag_12', '#11_Lag_1', '#11_Lag_1_RollingMean6', '#13_Lag_3_RollingMean3', '#12_Lag_12', 'ITA EE Producer Prices_Lag_12'], 'y_train_20': ['#6_Lag_1_RollingMean3', '#16_Lag_1', '#3_Lag_1', '#12_Lag_1_RollingMean3', 'Fossil_US_Lag_12_RollingMean3', '#5_Lag_1'], 'y_train_9': ['#36_Lag_1', '#4_Lag_1_RollingMean3', 'GER EE Production Index_Lag_12', '#20_Lag_1'], 'y_train_4': ['GER Production Index_Lag_12', 'Clean_US_Lag_12_RollingMean6', '#12_Lag_1', 'stock_price_change_Lag_12', 'Fossil_Chi_Lag_12_RollingMean3', 'Fossil_Ita_Lag_12_RollingMean3', 'CHI Production Index_Lag_12', 'Clean_Chi_Lag_12', '#3_Lag_1_RollingMean3', '#6_Lag_1_RollingMean3', '#16_Lag_1', '#3_Lag_1', 'Clean_Ita_Lag_12', 'USA Shipments Index_Lag_12', '#11_Lag_1_RollingMean6', '#9_Lag_1_RollingMean12'], 'y_train_11': ['#12_Lag_3', '#12_Lag_1', '#3_Lag_1_RollingMean6', 'stock_price_change_Lag_12', '#14_Lag_1', 'GER EE Production Index_Lag_12', '#8_Lag_1_RollingMean3', '#1_Lag_1_RollingMean6', '#1_Lag_1', '#3_Lag_1', '#1_Lag_1_RollingMean3', 'BC_CHI_Lag_12', 'stock_price_Lag_12_RollingMean3', '#4_Lag_6', 'GerHolidayCount'], 'y_train_5': ['#12_Lag_3', 'Clean_US_Lag_12_RollingMean6', 'stock_price_change_Lag_12', '#20_Lag_1', '#16_Lag_3', 'stock_volume_Lag_12', '#4_Lag_1_RollingMean3', '#13_Lag_3_RollingMean3', 'CC_CHI_Lag_12', '#5_Lag_1', '#12_Lag_12', '#4_Lag_6', 'CC_UK_Lag_12'], 'y_train_12': ['#12_Lag_3', '#14_Lag_6_RollingMean6', '#9_Lag_1_RollingMean6', '#4_Lag_6_RollingMean6', '#9_Lag_1_RollingMean3', '#6_Lag_1_RollingMean6', '#9_Lag_12', '#12_Lag_1_RollingMean6', 'Clean_Chi_Lag_12_RollingMean3', 'stock_price_change_Lag_12', '#12_Lag_1', '#20_Lag_1', '#14_Lag_1_RollingMean3', 'CHI Production Index_Lag_12', '#14_Lag_6_RollingMean3', '#16_Lag_1_RollingMean3', '#6_Lag_1', 'BC_CHI_Lag_12', '#9_Lag_1_RollingMean12', '#14_Lag_1', '#16_Lag_1_RollingMean6', '#4_Lag_1_RollingMean6', '#8_Lag_1_RollingMean3', 'Clean_Chi_Lag_12', '#36_Lag_12', '#12_Lag_1_RollingMean3', '#4_Lag_1_RollingMean3', 'SWI EE Production Index_Lag_12', 'CHI EE Producer Prices_Lag_12', '#16_Lag_3', 'Fossil_Swi_Lag_12', 'USA EUR to LCU Conversion Rate _Lag_12', 'FRA EE Producer Prices_Lag_12', '#6_Lag_1_RollingMean3', 'Clean_US_Lag_12', '#9_Lag_1', 'USA Shipments Index_Lag_12', 'USA Production Index_Lag_12', '#36_Lag_1', 'Clean_Ita_Lag_12_RollingMean3'], 'y_train_13': ['#8_Lag_3', '#14_Lag_1_RollingMean6', '#9_Lag_1_RollingMean6', '#6_Lag_1_RollingMean3', '#3_Lag_1', '#6_Lag_1_RollingMean6', 'cos_month'], 'y_train_6': ['#12_Lag_3', '#14_Lag_6', 'Fossil_Chi_Lag_12_RollingMean3', '#16_Lag_1', '#6_Lag_1_RollingMean6', 'CHI Production Index_Lag_12_RollingMean3', 'Fossil_Fra_Lag_12', '#13_Lag_1_RollingMean3', '#14_Lag_1_RollingMean3', '#20_Lag_1', '#8_Lag_3', '#11_Lag_1_RollingMean3', 'CHI Production Index_Lag_12', '#16_Lag_1_RollingMean3', '#6_Lag_1', '#3_Lag_1', '#5_Lag_1', 'SWI EE Production Index_Lag_12', '#14_Lag_1_RollingMean6'], 'y_train_16': ['#12_Lag_3', '#36_Lag_1_RollingMean3', '#14_Lag_6_RollingMean6', '#4_Lag_6_RollingMean6', '#9_Lag_1_RollingMean3', '#36_Lag_12_RollingMean3', '#6_Lag_1_RollingMean6', 'CC_UK_Lag_12_RollingMean3', '#12_Lag_1_RollingMean6', '#11_Lag_1_RollingMean3', '#9_Lag_12_RollingMean3', 'USA EE Producer Prices_Lag_12', '#14_Lag_6_RollingMean3', 'Fossil_US_Lag_12', '#6_Lag_1', 'BC_CHI_Lag_12', '#4_Lag_6', '#13_Lag_3_RollingMean6', 'JAP Production Index_Lag_12', 'GER EE Production Index_Lag_12', '#36_Lag_12', '#12_Lag_1_RollingMean3', 'GER EE Production Index_Lag_12_RollingMean3', '#4_Lag_6_RollingMean3', 'CC_CHI_Lag_12', 'Fossil_Swi_Lag_12', '#14_Lag_1_RollingMean6', 'FRA EE Producer Prices_Lag_12_RollingMean3', 'SWI EE Production Index_Lag_12_RollingMean3', '#9_Lag_1', 'UK EE Producer Prices_Lag_12_RollingMean3', '#16_Lag_3_RollingMean6', 'USA Shipments Index_Lag_12', 'Clean_Ita_Lag_12_RollingMean3'], 'y_train_3': ['#13_Lag_3_RollingMean6', '#14_Lag_1', '#20_Lag_1', 'Fossil_Chi_Lag_12_RollingMean3', 'USA EE Producer Prices_Lag_12_RollingMean6', 'FRA EE Producer Prices_Lag_12', '#36_Lag_12', 'TotalDaysInMonth', '#13_Lag_1', '#13_Lag_3_RollingMean3', 'cos_Quarter', '#12_Lag_12', 'cos_month'], 'y_train_1': ['#11_Lag_1_RollingMean6', '#9_Lag_12', '#12_Lag_1_RollingMean6', 'CC_UK_Lag_12_RollingMean3', 'CHI Production Index_Lag_12_RollingMean3', 'Fossil_Fra_Lag_12', '#14_Lag_1_RollingMean3', 'Clean_Ita_Lag_12', 'Fossil_Chi_Lag_12_RollingMean6', '#4_Lag_6', 'sin_Quarter', '#5_Lag_1_RollingMean3', 'USA Shipments Index_Lag_12_RollingMean3', '#20_Lag_1_RollingMean3', '#14_Lag_1_RollingMean6', '#3_Lag_1_RollingMean3', '#6_Lag_1_RollingMean3', 'Clean_US_Lag_12', 'Clean_Ita_Lag_12_RollingMean3'], 'y_train_14': ['JAP Production Index_Lag_12_RollingMean3', 'JAP Production Index_Lag_12', '#14_Lag_1', '#20_Lag_1', '#16_Lag_3', 'FRA EE Producer Prices_Lag_12', '#9_Lag_1', 'Clean_US_Lag_12_RollingMean3', 'GER EE Production Index_Lag_12_RollingMean3', '#13_Lag_1', 'USA Shipments Index_Lag_12_RollingMean3', '#13_Lag_3_RollingMean3', '#11_Lag_1_RollingMean12', 'Fossil_Fra_Lag_12', '#36_Lag_1_RollingMean6', '#9_Lag_1_RollingMean12', 'GerHolidayCount', 'CC_UK_Lag_12']}


df_mm_xgb_complex = {'y_train_36': ['stock_price_Lag_12',
  'Fossil_Ita_Lag_12',
  'GER Production Index_Lag_12',
  '#12_Lag_3',
  'Fossil_Chi_Lag_12_RollingMean3',
  '#6_Lag_1_RollingMean12',
  '#9_Lag_12',
  'CC_UK_Lag_12_RollingMean3',
  'Clean_Chi_Lag_12_RollingMean3',
  '#13_Lag_1_RollingMean3',
  '#8_Lag_3',
  '#16_Lag_1_RollingMean3',
  '#3_Lag_1_RollingMean12',
  'FRA Production Index_Lag_12',
  '#1_Lag_1_RollingMean3',
  'BC_CHI_Lag_12',
  '#14_Lag_1',
  '#5_Lag_1_RollingMean3',
  '#36_Lag_12',
  'GER EE Production Index_Lag_12_RollingMean3',
  '#4_Lag_1_RollingMean3',
  '#16_Lag_3_RollingMean6',
  'Clean_Fra_Lag_12'],
  
 'y_train_8': ['#13_Lag_3_RollingMean6',
  ...
  '#13_Lag_3_RollingMean3',
  '#12_Lag_12',
  'ITA EE Producer Prices_Lag_12'],

 'y_train_20': ['#6_Lag_1_RollingMean3',
  '#16_Lag_1',
  '#3_Lag_1',
 ...
 'y_train_4': ['GER Production Index_Lag_12',
  'Clean_US_Lag_12_RollingMean6',
  '#12_Lag_1',
  'stock_price_change_Lag_12',
  'Fossil_Chi_Lag_12_RollingMean3',
  'Fossil_Ita_Lag_12_RollingMean3',
  'CHI Production Index_Lag_12',
  'Clean_Chi_Lag_12',
  '#3_Lag_1_RollingMean3',
  '#6_Lag_1_RollingMean3',
  '#16_Lag_1',
  '#3_Lag_1',
  'Clean_Ita_Lag_12',
  'USA Shipments Index_Lag_12',
  '#11_Lag_1_RollingMean6',
  '#9_Lag_1_RollingMean12'],

 'y_train_11': ['#12_Lag_3',
  '#12_Lag_1',
  '#3_Lag_1_RollingMean6',
  'stock_price_change_Lag_12',
  '#14_Lag_1',
  'GER EE Production Index_Lag_12',
  '#8_Lag_1_RollingMean3',
  '#1_Lag_1_RollingMean6',
  '#1_Lag_1',
  '#3_Lag_1',
  '#1_Lag_1_RollingMean3',
  'BC_CHI_Lag_12',
  'stock_price_Lag_12_RollingMean3',
  '#4_Lag_6',
  'GerHolidayCount'],
 ...
 'y_train_12': ['#12_Lag_3',
  '#14_Lag_6_RollingMean6',
  '#9_Lag_1_RollingMean6',
  '#4_Lag_6_RollingMean6',
  '#9_Lag_1_RollingMean3',
  '#6_Lag_1_RollingMean6',
  '#9_Lag_12',
  '#12_Lag_1_RollingMean6',
  'Clean_Chi_Lag_12_RollingMean3',
  'stock_price_change_Lag_12',
  '#12_Lag_1',
  '#20_Lag_1',
  '#14_Lag_1_RollingMean3',
  'CHI Production Index_Lag_12',
  '#14_Lag_6_RollingMean3',
  '#16_Lag_1_RollingMean3',
  '#6_Lag_1',
  'BC_CHI_Lag_12',
  '#9_Lag_1_RollingMean12',
  '#14_Lag_1',
  '#16_Lag_1_RollingMean6',
  '#4_Lag_1_RollingMean6',
  '#8_Lag_1_RollingMean3',
  'Clean_Chi_Lag_12',
  '#36_Lag_12',
  '#12_Lag_1_RollingMean3',
  '#4_Lag_1_RollingMean3',
  'SWI EE Production Index_Lag_12',
  'CHI EE Producer Prices_Lag_12',
  '#16_Lag_3',
  'Fossil_Swi_Lag_12',
  'USA EUR to LCU Conversion Rate _Lag_12',
  'FRA EE Producer Prices_Lag_12',
  '#6_Lag_1_RollingMean3',
  'Clean_US_Lag_12',
  '#9_Lag_1',
  'USA Shipments Index_Lag_12',
  'USA Production Index_Lag_12',
  '#36_Lag_1',
  'Clean_Ita_Lag_12_RollingMean3'],
 ...
 'y_train_6': ['#12_Lag_3',
  ...
  '#16_Lag_1',
  '#6_Lag_1_RollingMean6',
  'CHI Production Index_Lag_12_RollingMean3',
  'Fossil_Fra_Lag_12',
  '#13_Lag_1_RollingMean3',
  '#14_Lag_1_RollingMean3',
  '#20_Lag_1',
 ...
 'y_train_16': ['#12_Lag_3',
  '#36_Lag_1_RollingMean3',
  '#14_Lag_6_RollingMean6',
  '#4_Lag_6_RollingMean6',
  '#9_Lag_1_RollingMean3',
  '#36_Lag_12_RollingMean3',
  '#6_Lag_1_RollingMean6',
  'CC_UK_Lag_12_RollingMean3',
  '#12_Lag_1_RollingMean6',
  '#11_Lag_1_RollingMean3',
  '#9_Lag_12_RollingMean3',
  'USA EE Producer Prices_Lag_12',
  '#14_Lag_6_RollingMean3',
  'Fossil_US_Lag_12',
  '#6_Lag_1',
  'BC_CHI_Lag_12',
  ...
  'JAP Production Index_Lag_12',
  'GER EE Production Index_Lag_12',
  '#36_Lag_12',
  '#12_Lag_1_RollingMean3',
  'GER EE Production Index_Lag_12_RollingMean3',
  '#4_Lag_6_RollingMean3',
  'CC_CHI_Lag_12',
  'Fossil_Swi_Lag_12',
  '#14_Lag_1_RollingMean6',
  'FRA EE Producer Prices_Lag_12_RollingMean3',
  'SWI EE Production Index_Lag_12_RollingMean3',
  '#9_Lag_1',
  'UK EE Producer Prices_Lag_12_RollingMean3',
  '#16_Lag_3_RollingMean6',
  'USA Shipments Index_Lag_12',
  'Clean_Ita_Lag_12_RollingMean3'],
 ...
 'y_train_3': ['#13_Lag_3_RollingMean6',
  ...
  '#20_Lag_1',
  'Fossil_Chi_Lag_12_RollingMean3',
  'USA EE Producer Prices_Lag_12_RollingMean6',
  'FRA EE Producer Prices_Lag_12',
  '#36_Lag_12',
  'TotalDaysInMonth',
  '#13_Lag_1',
 ...
 'y_train_1': ['#11_Lag_1_RollingMean6',
  '#9_Lag_12',
  '#12_Lag_1_RollingMean6',
  'CC_UK_Lag_12_RollingMean3',
  'CHI Production Index_Lag_12_RollingMean3',
  ...
  'sin_Quarter',
  '#5_Lag_1_RollingMean3',
  'USA Shipments Index_Lag_12_RollingMean3',
  '#20_Lag_1_RollingMean3',
  '#14_Lag_1_RollingMean6',
  '#3_Lag_1_RollingMean3',
  '#6_Lag_1_RollingMean3',
  'Clean_US_Lag_12',
 ...
 'y_train_14': ['JAP Production Index_Lag_12_RollingMean3',
  'JAP Production Index_Lag_12',
  '#14_Lag_1',
  '#20_Lag_1',
  '#16_Lag_3',
